  ...
  state = {
    services: [
      ...
      },
      {
        ...
        title: "Free Shuttle",
        info:
          "The shuttle runs Monday through Friday beginning at 5:00 am and provides free service around the City, with trips to local stores, senior centers, libraries, City Hall and parks."
      }
    ]
  };
  render() {
